        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div className="w-full h-full bg-black rounded-2xl border-2 border-[#D4AF37] p-3 sm:p-6 text-[#D4AF37] shadow-xl flex flex-row items-center justify-between relative overflow-hidden">

                        {/* Decorative Glow */}
                        <div className="absolute top-[-50%] left-[-50%] w-full h-full bg-[#D4AF37]/5 blur-3xl rounded-full"></div>

                        {/* Left Side: Logo Area */}
                        <div className="flex flex-col items-center justify-center text-left z-10 w-1/2 h-full shrink-0 border-r border-[#D4AF37]/20 pr-2 sm:pr-4">
                ...
                >
                    <div className="w-full h-full bg-black rounded-2xl border-2 border-[#D4AF37] p-6 text-[#D4AF37] shadow-xl flex flex-col relative overflow-hidden">
                        ...
                        <div className="text-center mb-4 z-10">
                            <h3 className="text-lg sm:text-2xl font-bold tracking-widest uppercase border-b-2 border-[#D4AF37] pb-1 inline-block">Our Services</h3>
                        </div>

                        {/* Content Grid */}
                        <div className="grid grid-cols-2 gap-x-4 gap-y-2 flex-grow content-center items-center text-[10px] sm:text-sm font-semibold z-10">
                        ...
                        <div className="mt-auto pt-2 text-center z-10">
                            <div className="text-[8px] sm:text-[10px] text-white/90 italic border-t border-[#D4AF37]/30 pt-2">
